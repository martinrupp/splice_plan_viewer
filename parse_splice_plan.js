...
/// parse_splice_plan: parse a splice plan an output a parsed tree
// input structure: a text plan generated by https://doc.splicemachine.com/cmdlineref_explainplan.html
//    e.g.
//    Cursor(n=6,rows=2369593,updateMode=READ_ONLY (1),engine=Spark)
//      ->  ProjectRestrict(n=4,totalCost=59891.557,outputRows=2369593,outputHeapSize=488.804 MB,partitions=1)`
//    see also parse_other / parse_first / parse_node, and example_plans.js
// output structure:
//    node.intend = integer, specfifying the intend level
//    node.name = string, name of node
//    node.options = {},
//      all additional info from the brackets:
//      node.options.n, rows, updateMode, engine, totalCost, outputHeapSize, partitions
//    node.children = [],
//      array of subnodes
